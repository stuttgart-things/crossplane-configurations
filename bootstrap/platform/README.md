...
|---|---|---|
| `platform` Configuration | `v0.4.4` | [`crossplane.yaml`](crossplane.yaml) |
| `xplane-platform` KCL module | `0.19.1` | [`apis/composition.yaml`](apis/composition.yaml) (OCI, pulled at render time) |
| `xplane-flux-catalog` KCL module | `0.14.0` | dependency of `xplane-platform` — the app definitions |
